...
activity_dict = {'Phone': {'heading': '<font color=#ffffff> Incoming Call </font>', \
           'subheading': 'Question', \
...
"content": "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Option 1 <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Option 2 <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Option 3<br> <font color=#008800> &nbsp; &nbsp; &nbsp; &nbsp; &#8594 Option 4* </font> ",
"html": 'true'},\
        'Menu1 Selected': {"content": "<font color=#008800> Option 1 Selected! </font>", "html": 'true'},\
        'Menu2 Selected': {"content": "<font color=#008800>  Option 2 Selected! </font>", "html": 'true'},\
        'Menu3 Selected': {"content": "<font color=#008800>  Option 3 Selected! </font>", "html": 'true'},\
        'Menu4 Selected': {"content": "<font color=#008800>  Option 4 Selected! </font>", "html": 'true'},\
        'Incorrect Option Selected': {"content": "<font color=#ff0000>  Wrong Menu Item Selected! </font>", "html": 'true'}
}


def schedule_event(post_data=activity_dict['Phone']):
    # global scheduler_time
    # ts = time.time()
...
def send_request_to_smartglasses(url, data):
    ...
    elif data == activity_dict['Phone']:
        curr_activity['activity'] = PHONE_CALL
...
def from_web_message(message):
    ...
    if curr_activity['activity'] == PHONE_CALL:
...
def from_web_message_call(message):
    ...
    for t in times:
        ...
        if i % 2 == 0:
            ...
            schedule.every().day.at(scheduler_time).do(schedule_event, activity_dict['Phone'])
        i+=1
